package com.bank.bian.financialinstrumentvaluation.model;
...
/**
 * The BIAN control record for this service domain: "Instrument Valuation Analysis".
 *
 ...
 * to its asset type (Instrument Valuation). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Instrument Valuation Analysis";
